...
class BottomRender implements \Hx\Document\Render\ComponentInterface {
	
	private $engine;
	
	public function __construct(\Hx\Document\Engine\PdfEngineInterface $pdfEngine)
	{
	...
	private function calculateBottom(\Hx\Document\Context\Component\BottomInterface $bottom)
	{
		$height = 0;
		$width = 0;
