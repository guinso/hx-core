...
class Span implements SpanInterface {
	...
	public function __construct()
	{
		...
		$this->verticalAlign = \Hx\Document\Context\Component\SpanInterface::VALIGN_NORMAL;
		
		$this->textAlign = \Hx\Document\Context\Component\SpanInterface::TEXT_ALIGN_LEFT;
		...
		$this->textBlockSize = new \Hx\Document\Context\Component\Box(0, 0);
	}
	...
	{
		if ($vAlign === \Hx\Document\Context\Component\SpanInterface::VALIGN_NORMAL || 
				$vAlign === \Hx\Document\Context\Component\SpanInterface::VALIGN_TOP ||
				$vAlign === \Hx\Document\Context\Component\SpanInterface::VLAIGN_BOTTOM)
	...
	{
		if ($vAlign === \Hx\Document\Context\Component\SpanInterface::TEXT_ALIGN_CENTRE ||
			$vAlign === \Hx\Document\Context\Component\SpanInterface::TEXT_ALIGN_LEFT ||
			$vAlign === \Hx\Document\Context\Component\SpanInterface::TEXT_LAIGN_RIGHT)
