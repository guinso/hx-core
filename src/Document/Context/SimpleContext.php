...
class SimpleContext implements \Hx\Document\Context\ContentInterface {
	
	private $header, $footer, $pages;
	private $margin, $paperStyle, $title, $author, $pageBreak;
	
	public function __construct(
		\Hx\Document\Context\Component\HeaderInterface $header, 
		\Hx\Document\Context\Component\FooterInterface $footer,
